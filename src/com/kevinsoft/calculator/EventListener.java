...
class EventListener implements View.OnKeyListener,
    ...
    public void onClick(View view) {
    	KevinSoundManager soundManager = KevinSoundManager.getInstance();
    	soundManager.playSound(((Button)view).getText().toString());
        int id = view.getId();
        switch (id) {
        case R.id.del:
            mHandler.onDelete();
        ...
        case R.id.equal:
            ...
            soundManager.playSeqSounds(soundsToPlay);
            break;
