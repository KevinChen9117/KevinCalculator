 ...
 */
@SuppressLint("NewApi") class CalculatorDisplay extends ViewSwitcher {

    private static final String ATTR_MAX_DIGITS = "maxDigits";
    private static final int DEFAULT_MAX_DIGITS = 8;
    ...
    enum Scroll { UP, DOWN, NONE ,RIGHT }

    TranslateAnimation inAnimUp;
    TranslateAnimation outAnimUp;
    TranslateAnimation inAnimDown;
    TranslateAnimation outAnimDown;
    TranslateAnimation inAnimRight;
    TranslateAnimation outAnimRight;
    ...
    protected void onSizeChanged(int w, int h, int oldW, int oldH) {
        ...
        inAnimRight.setDuration(ANIM_DURATION);
        outAnimRight = new TranslateAnimation(0, -w, 0, 0);
        outAnimRight.setDuration(ANIM_DURATION);
    }

    void insert(String delta) {
        EditText editor = (EditText) getCurrentView();
        //if the editor starts with 0 ,remove the 0
    	if(getText().toString().startsWith("0")){
    		editor.setText(getText().toString().substring(1));
    	}
...
//            dir = Scroll.NONE;
        ...
        if (dir == Scroll.UP) {
            ...
            setInAnimation(inAnimRight);
            setOutAnimation(outAnimRight);
        } else { // Scroll.NONE
            setInAnimation(null);
